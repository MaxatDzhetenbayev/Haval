export default {
	...
	more: "Подробнее",
	starting_price: "от {{price}} тг.",
	special_news: "Специальные новости",
	all_news: "Все новости",
	models: "Модельный ряд",
	models_text:
		"Выбор за вами! Оцените технологичные кроссоверы, пикапы и внедорожник Haval, адаптированные к казахстанским условиям.",
	test_head: "Хотите протестировать наши автомобили?",
	test_text: "Запишитесь на тест-драйв",
	test_link: "Записаться на тест драйв",
	location_head: "Как найти центр Haval?",
	location_text:
		" Вы всегда можете обратиться в официальный дилерский центр HAVAL по вопросам приобретения нового автомобиля, сдачи вашего в trade-in, а также, чтобы записаться на плановое ТО.",
	accordion_head: " Информация для посетителей автосалона",
	accordion: {
	...
	footer_text: `* Информация касательно стоимости, модельного ряда, характеристик,
 ...
 РК.`,
	footer_right: "© 2024, все права защищены",
};
